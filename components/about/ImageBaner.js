        ...
        <div className="flex flex-row md:justify-center">
          <h1 className="font-semibold">
            <span className="md:-mt-80 px-2 md:px-10 2xl:px-40 -mt-80 text-center absolute right-0 left-0 m-auto">
              <span className="text-primary-white filter brightness-100 z-50 text-3xl">
                ¿Cómo seleccionamos
              </span>
              <span className="text-primary-red text-3xl">
                {" "}
                los mejores productos?
              </span>
            </span>
          </h1>
          <p className="-mt-52 md:-mt-60 absolute mx-4 text-primary-white text-xl md:text-2xl md:w-8/12 font-primary text-center">
