      ...
      <footer className="max-w-screen-2xl px-4 md:px-8 mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-12 lg:gap-8 pt-4 lg:pt-12 mb-16">
          <div className="col-span-full lg:col-span-2">
            ...
            <p className="text-gray-400 sm:pr-8 mb-6">Queremos tener la mejor confianza hacia el cliente, por eso te invitamos a conectar</p>

            {/* <!-- social - start --> */}
            <div className="flex gap-4">
              <a href="#" target="_blank" className="text-gray-400 hover:text-primary-black active:text-gray-600 transition duration-100">
          ...
          {/* <!-- nav - start --> */}
          <div>
            <div className="text-gray-100 font-bold tracking-widest uppercase mb-4">Servicio</div>
            ...
            <nav className="flex flex-col gap-4">
              ...
              <div>
                <a href="#about" className="text-gray-400 hover:text-primary-red active:text-primary-red-hover transition duration-100">Clientes</a>
              </div>
            </nav>
          </div>
          {/* <!-- nav - end --> */}
          ...
          {/* <!-- nav - start --> */}
          <div>
            <div className="text-gray-100 font-bold tracking-widest uppercase mb-4">Soporte</div>

            <nav className="flex flex-col gap-4">
              <div>
                <a href="#contacto" className="text-gray-400 hover:text-primary-red active:text-primary-red-hover transition duration-100">Contacto</a>
              </div>

              <div>
                <a href="#contacto" className="text-gray-400 hover:text-primary-red active:text-primary-red-hover transition duration-100">Preguntas</a>
              </div>
            </nav>
          </div>
          {/* <!-- nav - end --> */}
          ...
          <div>
            ...
            <nav className="flex flex-col gap-4">
              <div>
                <a href="#" className="text-gray-400 hover:text-primary-red active:text-primary-red-hover transition duration-100">Terms of Service</a>
              </div>
        ...
        <div className="flex flex-col md:flex-row justify-evenly items-center gap-2">
          <div className="text-center md:text-left mb-3 md:mb-0">
            <span className="text-primary-red font-bold uppercase tracking-widest">Newsletter</span>
            <p className="text-primary-white">Subscribe to our newsletter</p>
          </div>
