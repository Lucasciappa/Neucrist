    ...
    <div class="bg-primary-black">
      <footer class="max-w-screen-2xl px-4 md:px-8 mx-auto">
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-12 lg:gap-8 pt-10 lg:pt-12 mb-16">
          ...
          {/* <!-- nav - start --> */}
          <div>
            <div class="text-gray-100 font-bold tracking-widest uppercase mb-4">Servicio</div>
          ...
          {/* <!-- nav - start --> */}
          <div>
            <div class="text-gray-100 font-bold tracking-widest uppercase mb-4">Companía</div>
            ...
            <nav class="flex flex-col gap-4">
              ...
              <div>
                <a href="#" class="text-gray-400 hover:text-primary-red active:text-primary-red-hover transition duration-100">Prensa</a>
              </div>
          ...
          {/* <!-- nav - start --> */}
          <div>
            <div class="text-gray-100 font-bold tracking-widest uppercase mb-4">Soporte</div>
          ...
          <div>
            ...
            <nav class="flex flex-col gap-4">
              <div>
                <a href="#" class="text-gray-400 hover:text-primary-red active:text-primary-red-hover transition duration-100">Terms of Service</a>
              </div>

              <div>
                <a href="#" class="text-gray-400 hover:text-primary-red active:text-primary-red-hover transition duration-100">Política de Privacidad</a>
              </div>
            </nav>
          </div>
          {/*  <!-- nav - end --> */}
        ...
        <div class="text-gray-400 text-sm text-center border-t border-gray-800 py-8">Copyright © 2022 LyC Creative.</div>
      </footer>
    </div>
  );
};
