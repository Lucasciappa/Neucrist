...
const HeroImage = () => {
    return (
        <div className="max-w-screen-2xl p-4 md:px-8 mx-auto z-20">
            <section className="flex justify-center items-center flex-1  max-w-screen-2xl shrink-0 bg-gray-100 overflow-hidden shadow-lg rounded-lg relative py-36 xl:py-48">
                ...
                <div className="sm:max-w-xl flex flex-col items-center relative p-4">
                    <p className="text-gray-200 text-lg font-semibold sm:text-xl text-center mb-2 md:mb-6">Bienvenidos a</p>
                    ...
                    <div className="w-full flex flex-col sm:flex-row sm:justify-center gap-2.5">
                        <a href="#" className="inline-block bg-primary-red hover:bg-primary-red-hover active:bg-primary-red-hover focus-visible:ring ring-primary-red-hover text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">Contáctame</a>
                    </div>
                </div>
            </section>
        </div>
