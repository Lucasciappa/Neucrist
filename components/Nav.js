    ...
    <>
      <header className="flex justify-between items-center bg-primary-dark py-1 md:py-2 px-4 md:px-8 mx-auto sticky top-0 z-50 shadow-shadow-bot">
        ...
        <nav className="hidden lg:flex gap-12">
          <a href="#" className="font-primary text-primary-red text-lg font-semibold">Inicio</a>
          <a href="#about" className="font-primary text-gray-600 hover:text-primary-red active:text-indigo-700 text-lg font-semibold transition duration-100">Quienes Somos</a>
          <a href="#productos" className="font-primary text-gray-600 hover:text-primary-red active:text-indigo-700 text-lg font-semibold transition duration-100">Productos</a>
          <a href="#servicios" className="font-primary text-gray-600 hover:text-primary-red active:text-indigo-700 text-lg font-semibold transition duration-100">Servicios</a>
        </nav>

        <a href="#contacto" className="hidden lg:inline-block bg-primary-red hover:bg-primary-red-hover text-white font-primary active:text-gray-700 text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">Contacto</a>
        ...
        <button type="button" className="inline-flex items-center lg:hidden bg-primary-dark text-primary-red text-sm md:text-base font-semibold gap-2 px-2.5 py-2">
          ...
          <div className="bg-primary-dark w-full h-60 absolute z-50 left-0 top-32 hamburguer shadow-shadow-bot" >
