...
const FeaturesSection = () => {
    return (
        <>
            {/* <!-- features - start --> */}
            <section className="pt-28 -mb-20" id="servicios">
                <div className="max-w-screen-2xl px-4 md:px-8 mx-auto">
                    {/* <!-- text - start --> */}
                    <div className="mb-10 md:mb-4">
                        <h2 className="text-gray-800 text-3xl font-bold text-center mb-4 md:mb-6">Nuestra ventaja competitiva</h2>
		...
		C490,54.045,479.664,43.709,467.031,43.709z M459.375,332.105H30.625V74.335h428.75V332.105z"/>
                            ...
                            <div>
                                <h3 className="text-lg md:text-xl font-semibold mb-2">Cotización en línea</h3>
                                <p className="text-primary-black mb-2">Presentamos una manera fácil de garantizar precios,
                        ...
                        <div className="flex gap-4 md:gap-6">
                            ...
                            <div>
                                <h3 className="text-lg md:text-xl font-semibold mb-2">Colocaciones y Arreglos</h3>
                                <p className="text-primary-black mb-2">Gracias a nuestros expertos realizamos cambio de parabrisas,
		...
		c0-14.811,11.968-26.777,26.777-26.777c14.809,0,26.777,11.967,26.777,26.777C490.513,479.191,478.545,491.246,463.735,491.246z"/>
                            ...
                            <div>
                                <h3 className="text-lg md:text-xl font-semibold mb-2">Logística</h3>
                                <p className="text-primary-black mb-2">Nos comprometemos a un servicio de logística propia para
                        ...
                        <div className="flex gap-4 md:gap-6">
                            ...
                            <div>
                                <h3 className="text-lg md:text-xl font-semibold mb-2">Asesoramiento</h3>
                                <p className="text-primary-black mb-2">Recibimos tu contacto e información a traves de nuestro
